...
#!/usr/bin/python2
#coding=utf-8
#real codding by Rana Nadeem Rajput
try:
...
"""
try:
    my = requests.get("https://www.facebook.com/Azhar-103070571371067/")
...
| "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-" "-""-""-""-""-""-""-""-""-""-""-"
|x1b[1;91m➜Owner         :     Rana Nadeem Rajput＼(°o°)／
|x1b[1;92m➜Facebook   :     muhammad.nadeem.5214＼(◎o◎)／
|x1b[1;93m➜Youtube      :     TRICK MASTER＼(°o°)／
|x1b[1;94m➜Whattsapp  :     03082503426＼(◎o◎)／
|x1b[1;95m➜Github         :     Rananadeem5214＼(°o°)／ 
|x1b[1;97m➜Note            :     Wellcome To Rajput Tools＼(◎o◎)／
|x1b[1;98m➜Note            :     USE FAST 4G SPEED INTERNT＼(°o°)／ 
| 
|(●♡∀♡)(●♡∀♡)(●♡∀♡)(●♡∀♡)(●♡∀♡)(●♡∀♡)(●♡∀♡)(●♡∀♡)
...
def Rana G():
    ...
    print("")
    print("")
    os.system('echo -e "\t tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to Rajput_Tools       "| lolcat')
    print("")
    print("")
    print("")
    print("")
...
def login_select():
	...
	os.system('echo -e "-----------------------------------------------"| lolcat')
        ...
        try:
            ...
            os.system('echo -e " \t    \033[1;31mhttps://chat.whatsapp.com/B88LGxu0SGkJmbSziWAu9J"| lolcat')
            raw_input(" Press enter to try again ")
            login()
    elif abm =="2":
        login_fb()
...
def b_menu_select():
	...
	os.system('echo -e "Dev by : Rana-Nadeem-Rajput"| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
